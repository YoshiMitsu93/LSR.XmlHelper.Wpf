...
{
    public sealed class GangDenPossibleVehicleSpawnsUpdaterService
    {
        public void Apply(XDocument locationsDoc, string gangId, List<PossibleVehicleSpawnModel> spawns)
        {
            ...
            spawns ??= new List<PossibleVehicleSpawnModel>();
            ...
            foreach (var den in dens)
            {
                ...
                var container = den.Element("PossibleVehicleSpawns");
                if (container is null)
                {
                    container = new XElement("PossibleVehicleSpawns");
                    den.Add(container);
                }
                else
                {
                ...
                foreach (var spawn in denSpawns)
                {
                    ...
                    SetOrCreate(element, "IsEmpty", "true");
                    ...
                    SetOrCreate(element, "RequiredVehicleGroup", (spawn.RequiredVehicleGroup ?? "").Trim());
                    SetOrCreate(element, "ForceVehicleGroup", "true");
                    SetOrCreate(element, "AllowAirVehicle", spawn.AllowAirVehicle ? "true" : "false");
                    SetOrCreate(element, "AllowBoat", spawn.AllowBoat ? "true" : "false");
        ...
        private static XElement CreateNewSpawnElement()
        {
            ...
            return new XElement("ConditionalLocation",
                ...
                new XElement("IsEmpty", "true"),
                new XElement("AllowAirVehicle", "false"),
                new XElement("AllowBoat", "false"),
                new XElement("TaskRequirements", "None"),
                new XElement("OverrideNightPercentage", "-1"),
                new XElement("OverrideDayPercentage", "-1"),
                new XElement("OverridePoorWeatherPercentage", "-1"),
                ...
                new XElement("ForceMelee", "false"),
                new XElement("ForceSidearm", "false"),
                new XElement("ForceLongGun", "false"),
                new XElement("RequiredVehicleGroup", ""),
                new XElement("ForceVehicleGroup", "true"),
                new XElement("TerritorySpawnsForceMainGang", "false"));
        }
