...
{
    public sealed class PossiblePedSpawnViewModel : ObservableObject
    {
        ...
        private bool _longGunAlwaysEquipped;
        ...
        public bool LongGunAlwaysEquipped
        {
            get => _longGunAlwaysEquipped;
            set => SetProperty(ref _longGunAlwaysEquipped, value);
        }
    }
}
